          ...
          <section className="dashboardV2">
            <div className="v2Hero">
              <div>
                ...
                <h3>Operations Ã¢â‚¬Â¢ Calibration Risk Ã¢â‚¬Â¢ PM Compliance</h3>
                <p>
                  ...
                  <div className="assetProfile vertical">
                    ...
                    <div className="profileMeta">
                      ...
                      {(() => {
                        ...
                        const attachmentLink = latestPm?.attachment_ref || latestPm?.attachment_url || latestPm?.attachment_link || latestPm?.file_url || latestPm?.file_name || "";
                        const attachmentLabel = attachmentLink ? "Open Link" : "Not Uploaded";
                        return (
                          <>
                            ...
                            <span>
                              Attachment: {attachmentLink ? (
                                <a href={attachmentLink} target="_blank" rel="noreferrer">Open Link</a>
                              ) : attachmentLabel}
                            </span>
        ...
        <section className="loginCardWrap">
          <div className="loginCard">
            ...
            <div className="loginFooterNote">
              Authorized personnel only Ã¢â‚¬Â¢ Secure operational access
            </div>
          </div>
        </section>
      </div>
...
function PmChecklistPage({ assets, sites, auth }) {
  const checklistOptions = [
    "F HSE 14 Ã¢â‚¬â€œ Monthly Visual Inspection of Portable Fire Extinguishers",
    "F HSE 16 Ã¢â‚¬â€œ Weekly Vehicle Check List",
    "F HSE 18 Ã¢â‚¬â€œ Forklift Truck Operator Pre-Use Checks",
    "F STR 04 Ã¢â‚¬â€œ Equipment Damage and Repair Report",
    "F STR 05 Ã¢â‚¬â€œ Preventive Maintenance Ã¢â‚¬â€œ Electrical Grinder, Blower, Drilling Machine",
    "F STR 08 Ã¢â‚¬â€œ Equipment Check List Ã¢â‚¬â€œ Rig Site",
    "F STR 16-A Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist",
    "F STR 16-B Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist",
    "F STR 16-C Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist",
    "F STR 17 Ã¢â‚¬â€œ Generator Checklist",
    "F STR 18 Ã¢â‚¬â€œ Shot Blasting Machine Checklist",
    "F STR 19 Ã¢â‚¬â€œ Portable Air Compressor Daily Checklist",
    "F STR 20 Ã¢â‚¬â€œ List of Service-Related Equipment",
    "F STR 21 Ã¢â‚¬â€œ Monitoring of Shelf-Life Sensitive Items",
    "F STR 22 Ã¢â‚¬â€œ Portable Diesel or Petrol Generator Checklist",
    "F STR 25 Ã¢â‚¬â€œ High Pressure Water Jet Unit Checklist",
    "F QMS 11 Ã¢â‚¬â€œ Calibration Status of Inspection, Monitoring and Test Equipment",
    "F RA 23 Ã¢â‚¬â€œ Textile Item Maintenance Checklist",
    "F RA 24 Ã¢â‚¬â€œ Metal Items and Helmet Maintenance Checklist",
    "F STR 26 Ã¢â‚¬â€œ List of Critical Spares",
    "F STR 27 Ã¢â‚¬â€œ Equipment Usage History",
    "F STR 29 Ã¢â‚¬â€œ Preventive Maintenance, Inspection and Test Plan",
    "F STR 30 Ã¢â‚¬â€œ MSDS Assessment",
  ];

  const emptyForm = {
    asset_id: "",
    checklist_type: "PM",
    checklist_name: "F STR 16-A Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist",
    checklist_date: "",
    performed_by: "",
  ...
  function startEdit(record) {
    ...
    setForm({
      ...
      checklist_name: record.checklist_name || "F STR 16-A Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist",
          ...
          <form className="formGrid" onSubmit={savePmRecord}>
            ...
            <label>
              ...
              <select value={pmForm.checklist_name} onChange={(e) => updatePmForm("checklist_name", e.target.value)}>
                <option value="F HSE 14 Ã¢â‚¬â€œ Monthly Visual Inspection of Portable Fire Extinguishers">F HSE 14 Ã¢â‚¬â€œ Monthly Visual Inspection of Portable Fire Extinguishers</option>
                <option value="F HSE 16 Ã¢â‚¬â€œ Weekly Vehicle Check List">F HSE 16 Ã¢â‚¬â€œ Weekly Vehicle Check List</option>
                <option value="F HSE 18 Ã¢â‚¬â€œ Forklift Truck Operator Pre-Use Checks">F HSE 18 Ã¢â‚¬â€œ Forklift Truck Operator Pre-Use Checks</option>
                <option value="F STR 04 Ã¢â‚¬â€œ Equipment Damage and Repair Report">F STR 04 Ã¢â‚¬â€œ Equipment Damage and Repair Report</option>
                <option value="F STR 05 Ã¢â‚¬â€œ Preventive Maintenance Ã¢â‚¬â€œ Electrical Grinder, Blower, Drilling Machine">F STR 05 Ã¢â‚¬â€œ Preventive Maintenance Ã¢â‚¬â€œ Electrical Grinder, Blower, Drilling Machine</option>
                <option value="F STR 08 Ã¢â‚¬â€œ Equipment Check List Ã¢â‚¬â€œ Rig Site">F STR 08 Ã¢â‚¬â€œ Equipment Check List Ã¢â‚¬â€œ Rig Site</option>
                <option value="F STR 16-A Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist">F STR 16-A Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist</option>
                <option value="F STR 16-B Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist">F STR 16-B Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist</option>
                <option value="F STR 16-C Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist">F STR 16-C Ã¢â‚¬â€œ Equipment Inspection Ã¢â‚¬â€œ PM Checklist</option>
                <option value="F STR 17 Ã¢â‚¬â€œ Generator Checklist">F STR 17 Ã¢â‚¬â€œ Generator Checklist</option>
                <option value="F STR 18 Ã¢â‚¬â€œ Shot Blasting Machine Checklist">F STR 18 Ã¢â‚¬â€œ Shot Blasting Machine Checklist</option>
                <option value="F STR 19 Ã¢â‚¬â€œ Portable Air Compressor Daily Checklist">F STR 19 Ã¢â‚¬â€œ Portable Air Compressor Daily Checklist</option>
                <option value="F STR 20 Ã¢â‚¬â€œ List of Service-Related Equipment">F STR 20 Ã¢â‚¬â€œ List of Service-Related Equipment</option>
                <option value="F STR 21 Ã¢â‚¬â€œ Monitoring of Shelf-Life Sensitive Items">F STR 21 Ã¢â‚¬â€œ Monitoring of Shelf-Life Sensitive Items</option>
                <option value="F STR 22 Ã¢â‚¬â€œ Portable Diesel or Petrol Generator Checklist">F STR 22 Ã¢â‚¬â€œ Portable Diesel or Petrol Generator Checklist</option>
                <option value="F STR 25 Ã¢â‚¬â€œ High Pressure Water Jet Unit Checklist">F STR 25 Ã¢â‚¬â€œ High Pressure Water Jet Unit Checklist</option>
                <option value="F QMS 11 Ã¢â‚¬â€œ Calibration Status of Inspection, Monitoring and Test Equipment">F QMS 11 Ã¢â‚¬â€œ Calibration Status of Inspection, Monitoring and Test Equipment</option>
                <option value="F RA 23 Ã¢â‚¬â€œ Textile Item Maintenance Checklist">F RA 23 Ã¢â‚¬â€œ Textile Item Maintenance Checklist</option>
                <option value="F RA 24 Ã¢â‚¬â€œ Metal Items and Helmet Maintenance Checklist">F RA 24 Ã¢â‚¬â€œ Metal Items and Helmet Maintenance Checklist</option>
                <option value="F STR 26 Ã¢â‚¬â€œ List of Critical Spares">F STR 26 Ã¢â‚¬â€œ List of Critical Spares</option>
                <option value="F STR 27 Ã¢â‚¬â€œ Equipment Usage History">F STR 27 Ã¢â‚¬â€œ Equipment Usage History</option>
                <option value="F STR 29 Ã¢â‚¬â€œ Preventive Maintenance, Inspection and Test Plan">F STR 29 Ã¢â‚¬â€œ Preventive Maintenance, Inspection and Test Plan</option>
                <option value="F STR 30 Ã¢â‚¬â€œ MSDS Assessment">F STR 30 Ã¢â‚¬â€œ MSDS Assessment</option>
              </select>
            </label>
